...
def PDPCONTEXT(input,output)
  # Set up a "counter" and initialize to 0
  entry_count = 0
  ...
  while !infile.eof?
     ...
     csvline = line.split(",")
     #print "#{csvline}\n"
     # Generate RDN: PDP_<entry count>
     PDP_entry_count = entry_count
     # Set up the LDIF entry for each line in the CSV by accessing the array. each element in the array is a value in the entry
     ldiffile.puts "dn: pdpContextName=#{PDP_entry count},o=pdpcontext,o=hlr,o=nss,o=services,o=default,DC=C-NTDB"
